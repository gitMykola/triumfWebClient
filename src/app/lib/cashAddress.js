...
function Address(data, network, type) {
    ...
    if (network && !Networks['BCH'][network]) {
    ...
    info.network = info.network || Networks['BCH'][network] || Networks['BCH'][defaultNetwork];
...
Address._transformObject = function(data) {
    ...
    return {
        ...
        network: Networks['BCH'][data.network] || Networks['BCH']['livenet'],
        type: data.type
    };
};
...
Address.fromPublicKey = function(data, network) {
    ...
    network = network || Networks['BCH']['livenet'];
