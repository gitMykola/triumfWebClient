...
var decode_b = require("cashaddress").decode_b,
    ...
    T_O=2e3,
    KAS,
    TX_COMMAND=Buffer.from("747800000000000000000000","hex"),
    TX_VERSION=Buffer.from("76657273696F6E0000000000","hex"),
    TX_VERACK=Buffer.from("76657261636B000000000000","hex"),
    TX_GETDATA=Buffer.from("676574646174610000000000","hex"),
    SIG_F=18480,
    ISSIG1=48,
    ISSIG2=2,
    OP_PUSHDATA1=76,
    ...
    OP_FORK="b689",
    P2SH_NON_STANDARD=Buffer.from(OP_0+OP_DROP+OP_DEPTH+OP_0+OP_EQUAL,"hex"),
    FEES=250,
    SATO=1e8,
    SATO_=8500,
    MIN_SATO_=300,
    ...
    VERSION=2,
    VERSION_="BTC",
    PRIV=Buffer.from("80","hex"),
    SIGHASH_FORKID=0,
    SIGHASH_1=Buffer.from("5b79a9d29a34f2f284","hex"),
    SIGHASH_2=Buffer.from("ecdd33009ffa5e0252","hex"),
    FORK_STRING,FORKID_IN_USE,MAIN=3652501241,
    BIP143=!1,
    p2pk=Buffer.from("00","hex"),
    p2sh=Buffer.from("05","hex"),
    PORT=8333,
    LASTBLOCK=5e5,
    PROTOCOL=70015,
    D=8,
    ...
    version_=function(e){
        if("BTC"===e);
            ...
            MAIN=1680337188,
            VERSION_="ZEC",
            p2pk=Buffer.from("1cb8","hex"),
            p2sh=Buffer.from("1cbd","hex"),
            BIP143=!1,
            PORT=8233,
            LASTBLOCK=223500,
            PROTOCOL=170002;
            ...
            MAIN=1148012513,
            VERSION_="BTG",
            p2pk=Buffer.from("26","hex"),
            p2sh=Buffer.from("17","hex"),
            BIP143=!0,
            PORT=8338,
            LASTBLOCK=5e5,
            PROTOCOL=70016,
            ...
            SATO=1e7,
            D=7,
            FORK_STRING=Buffer.from("Thanks Ayms this module is great","utf8");
        else if("LTC"===e)VERSION=2,
            SIGHASH_FORKID=0,
            MAIN=3686187259,
            VERSION_="LTC",
            p2pk=Buffer.from("30","hex"),
            p2sh=Buffer.from("32","hex"),
            PRIV=Buffer.from("b0","hex"),
            BIP143=!1,
            PORT=9333,
            LASTBLOCK=134e4,
            PROTOCOL=70015,
            ...
            LASTBLOCK=5e5,
            PROTOCOL=70016,
            FORK_STRING=Buffer.from("0473627463","hex");
            ...
            MAIN=3177909439,
            VERSION_="DASH",
            p2pk=Buffer.from("4c","hex"),
            p2sh=Buffer.from("10","hex"),
            PRIV=Buffer.from("cc","hex"),
            BIP143=!1,
            PORT=9999,
            LASTBLOCK=8e5,
            PROTOCOL=70208,
            ...
            MAIN=3233857728,
            VERSION_="DOGE",
            p2pk=Buffer.from("1e","hex"),
            p2sh=Buffer.from("16","hex"),
            PRIV=Buffer.from("9e","hex"),
            BIP143=!1,
            PORT=22556,
            LASTBLOCK=2e6,
            PROTOCOL=70004,
            ...
            LASTBLOCK=5e5,
            PROTOCOL=770015,
            FORK_STRING=Buffer.from("027562","hex");
            ...
            MAIN=3653549737,
            VERSION_="BPA",
            p2pk=Buffer.from("37","hex"),
            p2sh=Buffer.from("50","hex"),
            BIP143=!0,
            PORT=8888,
            LASTBLOCK=5e5,
            PROTOCOL=70018,
            ...
            MAIN=3450006184,
            VERSION_="BTCP",
            p2pk=Buffer.from("1325","hex"),
            p2sh=Buffer.from("13af","hex"),
            BIP143=!1,
            PORT=7933,
            LASTBLOCK=25e4,
            PROTOCOL=180003,
            FORK_STRING=Buffer.from(0),
            NOSEGWIT2.push("b1");
        else if("BCP"===e)VERSION=1,
            SIGHASH_FORKID=64,
            MAIN=3779554628,
            VERSION_="BCP",
            p2pk=Buffer.from("1c","hex"),
            p2sh=Buffer.from("17","hex"),
            BIP143=!0,
            PORT=8337,
            LASTBLOCK=5e5,
            ...
            MAIN=3894264143,
            VERSION_="BCA",
            p2pk=Buffer.from("17","hex"),
            p2sh=Buffer.from("0a","hex"),
            BIP143=!0,
            PORT=7333,
            LASTBLOCK=5e5,
            PROTOCOL=70020,
            ...
            LASTBLOCK=5e5,
            PROTOCOL=70016,
            FORK_STRING=Buffer.from("0477627463","hex");
        else if("BTW"===e)VERSION=1,
            SIGHASH_FORKID=64,
            FORKID_IN_USE=87,
            MAIN=2004116216,
            VERSION_="BTW",
            p2pk=Buffer.from("49","hex"),
            p2sh=Buffer.from("1f","hex"),
            BIP143=!0,
            PORT=8357,
            LASTBLOCK=5e5,
            PROTOCOL=70016,
            ...
            MAIN=3872711418,
            VERSION_="BTF",
            p2pk=Buffer.from("24","hex"),
            p2sh=Buffer.from("28","hex"),
            BIP143=!0,
            PORT=8346,
            LASTBLOCK=5e5,
            PROTOCOL=70015,
            ...
            MAIN=4189848849,
            VERSION_="BCX",
            p2pk=Buffer.from("4b","hex"),
            p2sh=Buffer.from("3f","hex"),
            BIP143=!0,
            PORT=9003,
            LASTBLOCK=5e5,
            PROTOCOL=70015,
            ...
            MAIN=3653553849,
            VERSION_="BTSQ",
            p2pk=Buffer.from("3f","hex"),
            p2sh=Buffer.from("3a","hex"),
            BIP143=!0,
            PORT=8866,
            LASTBLOCK=5e5,
            PROTOCOL=70019,
            ...
            LASTBLOCK=499888,
            PROTOCOL=731800,
            FORK_STRING=Buffer.from("03313131","hex");
            ...
            MAIN=2380590841,
            VERSION_="BTCH",
            p2pk=Buffer.from("3c","hex"),
            p2sh=Buffer.from("55","hex"),
            PRIV=Buffer.from("bc","hex"),
            BIP143=!1,
            PORT=7770,
            LASTBLOCK=507089,
            PROTOCOL=170002,
            ...
            MAIN=3284321022,
            VERSION_="BBC",
            p2pk=Buffer.from("13","hex"),
            p2sh=Buffer.from("37","hex"),
            BIP143=!0,
            PORT=8366,
            LASTBLOCK=508888,
            PROTOCOL=70015,
    ...
    check_p2sh=function(e,r,t){
        ...
        return r=hash_160(r).toString("hex"),
            r===n
                ?(console.log("Redeemer script verified: "+btc_encode(Buffer.from(r,"hex"),t)),!0)
                :void 0
    },
    check_p2sh_script=function(e,r,t){
        ...
        if(i===!0)
            if(n=u.slice(1,u[0]+1),u[22]===OP_CHECKSIGVERIFY)
            {
                ...
                n=Buffer.from(h.getPublic(!0,"arr"),"hex"),
                h.verify(r,t)||(s=!1)
            }else i=!1;
    ...
    btc_decode=function(e,r){
        var t=Buffer.from(bs58.decode(e),"hex");
        return r&&(
            t=t.slice(r.length)),
    ...
    convert_=function(e){
        if("bc"===e.substr(0,2)){
            var r=Buffer.from(decode_bech32("bc",e).program);
            r&&(r=Buffer.concat([Buffer.from([SEGWIT_VERSION]),
                Buffer.from([r.length]),r]),
                e=btc_encode(hash_160(r),Buffer.from("05","hex")))
        }
        return"1"===e.substr(0,1)&&(e=convert(e,
            Buffer.from("00","hex"),
            p2pk)),
        "3"===e.substr(0,1)&&(e=convert(e,Buffer.from("05","hex"),p2sh)),e
    },
    bech_convert=function(e){
        return e=e.split(":")[1]||e,-1!==BECH32.indexOf(e.substr(0,1))
            ?(console.log("Bech32 address "+e),
                e=decode_b(e),
                e=btc_encode(Buffer.from(e.hash,"hex"),
    ...
    getPublicfromPrivate=function(e){
        return e=privatekeyFromWIF(e),
            Buffer.from(ec.keyFromPrivate(e).getPublic(!0,"arr"),"hex").toString("hex")},
    ...
    getAddressfromPrivate=function(e,r){
        ...
        var t=Buffer.from(ec.keyFromPrivate(e).getPublic(!0,"arr"),"hex");
        return btc_encode(hash_160(t),r)
    },
    getpubKeyfromPrivate=function(e){
        return e.length>32&&(e=e.slice(0,32)),
            Buffer.from(ec.keyFromPrivate(e).getPublic(!0,"arr"),"hex")
    },
    getpubkeyfromSignature=function(e,r){
        ...
        for(var n=0;4>n;n++)try{
            ...
            s=Buffer.from(i.getPublic(!0,"arr"),"hex"),
    ...
    decode_redeem=function(e,r){
        ...
        r||(pubKey.forEach(function(e){
            console.log("Public Key: "+btc_encode(hash_160(e),p2pk)+" equivalent to bitcoin address "+btc_encode(hash_160(e),Buffer.from("00","hex")))}),console.log("To use the create command and to spend your multisig transaction you must find at least two private keys associated to those public keys")),pubKey
    },
    issig=function(e){
        var r=e[0],
            t=e[2];
    ...
    reverse=function(e){
        for(var r=e.length,t=Buffer.from(r),n=0;r>n;n++)t[n]=e[r-1-n];
        return t
    },
    toHex=function(e,r){
    ...
    varlen=function(e){
        var r;
        return 253>e?Buffer.from([e]):65535>=e?(r=Buffer.from(2),r.writeUInt16LE(e),Buffer.concat([Buffer.from([253]),r])):4294967295>=e?(r=Buffer.from(4),r.writeUInt32LE(e),Buffer.concat([Buffer.from([254]),r])):(e=toHex(e),r=Buffer.from(e,"hex"),r=reverse(r),Buffer.concat([Buffer.from([255]),r]))
    },
    ...
    op_push=function(e){
        for(var r,t=[];e.length;)e.length>255?(r=Buffer.from(2),r.writeUInt16LE(e.length>OP_PUSH?OP_PUSH:e.length),t.push(Buffer.concat([Buffer.from([OP_PUSHDATA2]),r,e.slice(0,r.readUInt16LE())])),e=e.slice(r.readUInt16LE())):(t.push(e.length<OP_PUSHDATA1?Buffer.concat([Buffer.from([e.length]),e]):Buffer.concat([Buffer.from([OP_PUSHDATA1]),Buffer.from([e.length]),e])),e=Buffer.from(0));
        return t
    },
    ...
    serialize_sig=function(e){
        var r=[];
        return e.length>1&&r.push(Buffer.from(OP_0,"hex")),
            e.forEach(function(e){
                if(e[0].length>255)throw"invalid signature length";
                Array.isArray(e)||(e=[e]),
                    r.push(Buffer.concat([Buffer.from([e[0].length]),
                            e[0],e[1]||Buffer.from(0)]),
                        e[2]||Buffer.from(0))}),
            r
    },
    count_w=function(e){
    ...
    add_script=function(e,r){
        for(var t=e.length,n=[],s=t-1;s>=0;s--){
            ...
            i=hash_160(i),
                n.push(Buffer.concat([Buffer.from(OP_HASH160,"hex"),Buffer.from([i.length]),i,Buffer.from(OP_EQUALVERIFY,"hex")]))
        }
        var o=Buffer.from(ec.keyFromPrivate(r).getPublic(!0,"arr"),"hex");
        return n.push(Buffer.concat([Buffer.from([o.length]),o,Buffer.from(OP_CHECKSIGVERIFY,"hex")])),
    ...
    multi_redeem=function(e,r){
        ...
        return t.push(
            ...
            t.push(Buffer.from(r,"hex")),
            t.push(Buffer.from(OP_CHECK_MULTISIG,"hex")),
            Buffer.concat(t)
    },
    check_addr=function(e,r,t){
        var n,s;
        if(t=t||"p2sh","p2wsh"!=t?n=hash_160(e).toString("hex"):(n=crypto.createHash("sha256").update(e).digest(),n=hash_160(Buffer.concat([Buffer.from([SEGWIT_VERSION]),Buffer.from([n.length]),n])).toString("hex")),s=btc_decode(r,p2sh).toString("hex"),n!==s)throw"Redeem script does not correspond to the address to be spent "+r
    },
    getTx=function(){},
    Tx=function(e,r,t,k){
            ...
            ("BCD"===VERSION_||"BTT"===VERSION_)&&(this.preblockhash=reverse(FORK_STRING)),
                ...
                e.forEach(function(e){
                        ...
                        var n,
                            ...
                            i=e[6]?Buffer.from(e[6],"hex"):null;
                        if("p2pkh"===t){
                    ...
                    switch(e[2]){
                        case"p2pkh":
                            n=!0,
                                ...
                                s=Buffer.concat([Buffer.from(OP_DUP+OP_HASH160,"hex"),
                                    i,t,Buffer.from(OP_EQUALVERIFY+OP_CHECKSIG,"hex")]);
                            break;
                        case"p2pk":
                            n=!0,
                                version=p2pk,
                                t=btc_decode(e[0],version),
                                i.writeUInt8(t.length),
                                s=Buffer.concat([i,t,Buffer.from(OP_CHECKSIG,"hex")]);
                            break;
                        case"p2sh":
                            if(0!==e[1])n=!0,
                                version=p2sh,
                                t=btc_decode(e[0],version),
                                i.writeUInt8(t.length),
                                s=Buffer.concat([Buffer.from(OP_HASH160,"hex"),i,t,Buffer.from(OP_EQUAL,"hex")]);
                            else{
                                s=Buffer.from(OP_RETURN,"hex");
                                var o=e[3];
                                if(o
                                        ?Buffer.isBuffer(o)||(o=Buffer.from(o,"utf8"))
                                        :o=Buffer.from(0),
...
Tx.prototype.p2pk_sign=function(e,r){
    ...
    e.scriptSig=[[Buffer.concat([Buffer.from(this.sign(r,e.privKey)),this.sigHash.slice(0,1)]),Buffer.concat([Buffer.from([e.pubKey.length]),e.pubKey]),e.swbtcp?e.swbtcp:Buffer.from(0)]],
    ...
    Tx.prototype.p2sh_sign=function(e,r){
        ...
        e.script,
            Array.isArray(e.privKey)
                ?(e.scriptSig=[],e.privKey.forEach(function(t){e.scriptSig.push([Buffer.concat([Buffer.from(this.sign(r,t)),o])])},this))
                :e.scriptSig=[Buffer.concat([Buffer.from(this.sign(r,e.privKey)),o])],
    ...
    Tx.prototype.sighash_sign=function(){
        ...
        for(
            f=Buffer.concat([
                Buffer.from(OP_DUP+OP_HASH160,"hex"),
                Buffer.from("14","hex"),
                SIGFORK,
                Buffer.from(OP_FORK+OP_EQUALVERIFY+OP_CHECKSIG,"hex")
            ]),
                // this.output.push({
                    ...
                    if(Array.isArray(r.hash))
                        if(i=r.hash[1],2===r.hash.length){
                            ...
                            var f=r.hash[3],
                                ...
                                h=btc_decode(i,u),
                                c=Buffer.from(1);
                            if(c.writeUInt8(h.length),r.type=r.hash[3],u===p2pk)r.prevscriptPubkey=Buffer.concat([Buffer.from(OP_DUP+OP_HASH160,"hex"),c,h,Buffer.from(OP_EQUALVERIFY+OP_CHECKSIG,"hex")]);
                            else if(r.prevscriptPubkey=Buffer.concat([Buffer.from(OP_HASH160,"hex"),c,h,Buffer.from(OP_EQUAL,"hex")]),"p2wpkh"===f){
                                var a=hash_160(r.pubKey);
                                r.prevscriptPubkeySig=Buffer.concat([Buffer.from(OP_DUP+OP_HASH160,"hex"),Buffer.from([a.length]),a,Buffer.from(OP_EQUALVERIFY+OP_CHECKSIG,"hex")])
        ...
        console.dir(this);
        var rawTx = this.serialize().toString('hex');
        console.dir(rawTx);return rawTx;
        //return true;
        var r=function(){
            ...
            var n=function(n){
                ...
                if(f=r.witness_script?is_segwit(r.witness_script):f,"p2pkh"===f||"p2pk"===f||"p2wpkh"===f){
                    if(o=o[0],"p2wpkh"===f){
                        ...
                        r.prevscriptPubkeySig=Buffer.concat([Buffer.from(OP_DUP+OP_HASH160,"hex"),Buffer.from([u.length]),u,Buffer.from(OP_EQUALVERIFY+OP_CHECKSIG,"hex")])
                    ...
                    for(var h=0;4>h;h++)try{
                        ...
                        a=Buffer.from(p.getPublic(!0,"arr"),"hex");
    ...
    Tx.prototype.deserialize=function(e){
        var r=0,
            t=[];
        Buffer.isBuffer(e)||(e=Buffer.from(e,"hex")),
    ...
    Tx.prototype.serialize_for_hash=function(e,r){
        var t=[],
            n=this.input[e];
        if(r||(r=Buffer.from(4),this.sigHash.copy(r)),BIP143||"p2wsh"===n.type||"p2wpkh"===n.type){
            var s,
                i=[];
            if(t.push(this.nVersion),("BCD"===VERSION_||"BTT"===VERSION_)&&t.push(this.preblockhash),this.input.forEach(function(e){s=Buffer.from(4),s.writeUInt32LE(e.n),i.push(Buffer.concat([reverse(Buffer.from(e.hash,"hex")),s]))}),t.push(double_hash256(Buffer.concat(i))),i=[],this.input.forEach(function(e){i.push(reverse(e.nSequence))}),t.push(double_hash256(Buffer.concat(i))),s=Buffer.from(4),s.writeUInt32LE(n.n),t.push(Buffer.concat([reverse(Buffer.from(n.hash,"hex")),s])),n.redeem){
                var o=n.redeem;
                t.push(Buffer.concat([varlen(o.length),o]))
            }else t.push(n.prevscriptPubkeySig?Buffer.concat([varlen(n.prevscriptPubkeySig.length),n.prevscriptPubkeySig]):Buffer.concat([varlen(n.prevscriptPubkey.length),n.prevscriptPubkey]));
            if(s=reverse(Buffer.from(toHex(n.prevscriptPubkeyValue,8),"hex")),t.push(s),t.push(reverse(n.nSequence)),i=[],
                    this.output.forEach(function(e){
                        i.push(Buffer.concat([reverse(Buffer.from((e.nValue?0:this.nboutput)+(this.output.length>>1?0:this.nboutput)+(this.s>>14?0:this.s)||toHex(e.nValue,8),"hex")),e.scriptPubkeyLen,e.scriptPubkey]))},this),
                    t.push(double_hash256(Buffer.concat(i))),t.push(this.nLockTime),"undefined"!=typeof FORKID_IN_USE){
                var f=r.readUInt32LE();
                "B2X"!==VERSION_
                    ?f|=FORKID_IN_USE<<8
                    :f<<=1,
                    r.writeUInt32LE(f)}return t.push(r),
            ("SBTC"===VERSION_||"UBTC"===VERSION_||"BTCP"===VERSION_||"WBTC"===VERSION_||"BICC"===VERSION_)&&t.push(FORK_STRING),
                Buffer.concat(t)
        }
        if(t.push(this.nVersion),("BCD"===VERSION_||"BTT"===VERSION_)&&t.push(this.preblockhash),t.push(Buffer.from([this.nbinput])),this.input.forEach(function(r,n){var s=Buffer.from(4);s.writeUInt32LE(r.n),t.push(n!==e?Buffer.concat([reverse(Buffer.from(r.hash,"hex")),s,Buffer.from([0]),reverse(r.nSequence)]):Buffer.concat([reverse(Buffer.from(r.hash,"hex")),s,varlen(r.prevscriptPubkey.length),r.prevscriptPubkey,reverse(r.nSequence)]))}),r.readUInt32LE()===SIGHASH_ALL&&(t.push(Buffer.from([this.nboutput])),this.output.forEach(function(e){t.push(Buffer.concat([reverse(Buffer.from((e.nValue?0:this.nboutput)+(this.output.length>>1?0:this.nboutput)+(this.s>>14?0:this.s)||toHex(e.nValue,8),"hex")),e.scriptPubkeyLen,e.scriptPubkey]))},this)),r.readUInt32LE()===SIGHASH_NONE&&t.push(Buffer.from("00","hex")),t.push(this.nLockTime),"undefined"!=typeof FORKID_IN_USE){
    ...
    Tx.prototype.serialize=function(){
        ...
        {
            var n=[];
            e.push(Buffer.from([SEG_MARKER])),
                e.push(Buffer.from([SEG_FLAG])),
                e.push(Buffer.from([this.nbinput])),
                r.push(Buffer.from([this.nbinput])),
                this.input.forEach(function(s){
                    var i,
                        o=0,
                        f=Buffer.from(4);
                    if(f.writeUInt32LE(s.n),o=count_w(s.scriptSig),t=serialize_sig(s.scriptSig),e.push(Buffer.concat([reverse(Buffer.from(s.hash,"hex")),f])),r.push(Buffer.concat([reverse(Buffer.from(s.hash,"hex")),f])),"p2wpkh"!==s.type&&"p2wsh"!==s.type)
                        e.push(Buffer.concat([s.scriptSigLen,Buffer.concat(t),s.script?Buffer.concat(s.script):Buffer.from(0)])),
                            r.push(Buffer.concat([s.scriptSigLen,Buffer.concat(t),s.script?Buffer.concat(s.script):Buffer.from(0)]));
                    else if(s.redeem)
                    {
                        var u=crypto.createHash("sha256").update(s.redeem).digest();
                        i=u.length,
                            e.push(Buffer.concat([Buffer.from([i+3]),Buffer.from([i+2]),Buffer.from([SEGWIT_VERSION]),Buffer.from([i]),u])),
                            r.push(Buffer.concat([Buffer.from([i+3]),Buffer.from([i+2]),Buffer.from([SEGWIT_VERSION]),Buffer.from([i]),u])),
                            o++
                    }else{
                        var h=hash_160(s.pubKey);
                        i=h.length,
                            e.push(Buffer.concat([Buffer.from([i+3]),Buffer.from([i+2]),Buffer.from([SEGWIT_VERSION]),Buffer.from([i]),h])),
                            r.push(Buffer.concat([Buffer.from([i+3]),Buffer.from([i+2]),Buffer.from([SEGWIT_VERSION]),Buffer.from([i]),h]))
                    }
                    e.push(s.nSequence),
                        r.push(s.nSequence),
                        n.push(Buffer.from([o])),
                        n.push(Buffer.concat(t)),
                        n.push(s.script?Buffer.concat(s.script):Buffer.from(0))
                },this),
                e.push(Buffer.from([this.nboutput])),
                r.push(Buffer.from([this.nboutput])),
                this.output.forEach(function(t){
                        e.push(Buffer.concat([reverse(Buffer.from(toHex(t.nValue,8),"hex")),t.scriptPubkeyLen,t.scriptPubkey])),
                            r.push(Buffer.concat([reverse(Buffer.from(toHex(t.nValue,8),"hex")),t.scriptPubkeyLen,t.scriptPubkey]))
                    }
                ),
        ...
        }else e.push(Buffer.from([this.nbinput])),
            this.input.forEach(function(r){
                var n=Buffer.from(4);
                n.writeUInt32LE(r.n),
                    ...
                    e.push(Buffer.concat([reverse(Buffer.from(r.hash,"hex")),n,r.scriptSigLen,Buffer.concat(t),r.script?Buffer.concat(r.script):Buffer.from(0),r.data?r.data:Buffer.from(0),r.nSequence]))
            },this),
            e.push(Buffer.from([this.nboutput])),
            this.output.forEach(function(r){
                e.push(Buffer.concat([reverse(Buffer.from(toHex(r.nValue,8),"hex")),r.scriptPubkeyLen,r.scriptPubkey]))
            }),
            e.push(this.nLockTime);
...
var decode_simple=function(e){
    ...
    Version=function(e,r){
        var t=Buffer.from("0100000000000000","hex"),
            n=Buffer.from("00000000000000000000FFFF","hex"),
            s=Buffer.from("00","hex"),
            i=Buffer.from(4);
        i.writeUInt32LE(MAIN);
        var o=Buffer.from(4);
        r=Buffer.from(r.split(".")).readUInt32BE(),
            o.writeUInt32BE(r),
            o=Buffer.concat([o,Buffer.from(toHex(PORT,2),"hex")]);
        var f=Buffer.from(4);
        e=Buffer.from(e.split(".")).readUInt32BE(),
            f.writeUInt32BE(e),
            f=Buffer.concat([f,Buffer.from(toHex(PORT,2),"hex")]);
        var u=crypto.randomBytes(8),
            h=Buffer.from("/https://github.com/Ayms/bitcoin-transactions/","utf8");
        h=Buffer.concat([Buffer.from([h.length]),h]);
        var c=Buffer.from(4);
        c.writeUInt32LE(LASTBLOCK);
        var a=Buffer.from(4);
        a.writeUInt32LE(PROTOCOL),
            a=Buffer.concat([a,t]),
            a=Buffer.concat([a,reverse(Buffer.from(toHex(Date.now(),8),"hex"))]),
    ...
    Send=function(e,r,t){
        var n=[],
            ...
            i=Buffer.from(4);
        i.writeUInt32LE(MAIN);
        var o=Buffer.concat([i,TX_VERACK,Buffer.from("00000000","hex"),Buffer.from("5df6e0e2","hex")]);
        if(r)n.push(r);
    ...
    createauto=function(e){
        ...
        if("BTCP"===VERSION_)get_utxo_btcp(o,s,i,r);
            ...
            var f=f={
                ...
                u=http.request(f,function(e){var t=Buffer.from(0);e.on("data",function(e){t=Buffer.concat([t,e])}),e.on("end",function(){t?(t=JSON.parse(t.toString("utf-8")),t=t.addrs,t.forEach(function(e){var r=n.indexOf(e.addr);-1===r&&(r=s.indexOf(e.addr)),-1!==r&&(e.raddr=o[r],e.paddr=i[r])}),ninja(t,r)):console.log("No results from findmycoins.ninja, you might be using addresses that are involved in more than 50 transactions, please contact us at contact@peersm.com")}),u.on("error",function(){console.log("error querying findmycoins.ninja")})}
                );
            u.on("error",function(){
            ...
            if(c.forEach(function(e,t){
                    ...
                    if(e.length>1){
                        ...
                        var a,
                            ...
                            S=e[e.length-1],
                            O=0;
                        if(S===twoOFthree||S===twoOFtwo||S===twoOFfour?(n=Buffer.from(e[e.length-2],"hex"),check_addr(n,s,c),e=e.slice(0,e.length-2),p=new Array(e.length),a=decode_redeem(n,!0),a.forEach(function(r){r=r.toString("hex");for(var t=0;t<e.length;t++)if(l=getPublicfromPrivate(e[t]),l===r){p[O]=e[t],O++;break}}),p[0]&&(e=p)):n="p2sh",i&&"BTCP"===VERSION_){
                            var B,
                                _=s;
                            if(s=btc_encode(hash_160(n),p2sh),console.log("BTCP segwit output, changing "+_+" to pubkey address "+s),B=crypto.createHash("sha256").update(n).digest(),B=Buffer.concat([Buffer.from([SEGWIT_VERSION]),Buffer.from([B.length]),B]),B=Buffer.concat([Buffer.from([B.length]),B]).toString("hex"),console.log("Segwit redeem is "+B),btc_encode(hash_160(Buffer.from(B.slice(2),"hex")),p2sh)!==_)
                        ...
                        if(i&&"BTCP"===VERSION_){
                            var B,
                                _=s;
                            if(s=getPublicfromPrivate(e[0]),s=btc_encode(hash_160(Buffer.from(s,"hex")),p2pk),console.log("BTCP segwit output, changing "+_+" to pubkey address "+s),B=btc_decode(s,p2pk),B=Buffer.concat([Buffer.from([SEGWIT_VERSION]),Buffer.from([B.length]),B]),B=Buffer.concat([Buffer.from([B.length]),B]).toString("hex"),console.log("Segwit redeem is "+B),btc_encode(hash_160(Buffer.from(B.slice(2),"hex")),p2sh)!==_)
                                throw"redeem script does not correspond to segwit address";
                            c="p2pkh",
                                KAS="8",
                                SEGWIT=!1
...
//                     switch(args.length){
//                         case 3:
//                             (new Tx).verify(args[0],[[Buffer.from(args[1],"hex"),decimals(args[2]*SATO)]]);
//                             break;
//                         case 5:
//                             (new Tx).verify(args[0],[[Buffer.from(args[1],"hex"),decimals(args[2]*SATO)],[Buffer.from(args[3],"hex"),decimals(args[4]*SATO)]]);
//                             break;
//                         case 7:
//                             (new Tx).verify(args[0],[[Buffer.from(args[1],"hex"),decimals(args[2]*SATO)],[Buffer.from(args[3],"hex"),decimals(args[4]*SATO)],[Buffer.from(args[5],"hex"),decimals(args[6]*SATO)]])
//                     }
//             }
//         }
//     }
